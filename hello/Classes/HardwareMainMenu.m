...

{
	...
	if (self)
	{
		...
		//BTDevice
		//[_names addObject: [NSString stringWithFormat: @"BT: %@", [[BTDevice bd_addr_t]  _address]]];
		//[_names addObject: [NSString stringWithFormat: @"BT: %@", [BTDevice name ]]];
		...
		[_names addObject: [NSString stringWithFormat: @"systemNumber : %d", [[UIDevice currentDevice] systemNumber]]];//312
